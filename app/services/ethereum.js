...
export default Service.extend({
  ...
  rewarderAddress: computed('environment', 'network', function() {
    return "0x42a10bce8648ffdeb0f8dda7199c1043aae4b1d7"; // merkleDistributor
  }),
  ...
  shibAddresses: computed('environment', function() {
    return {
      production: '0xd7e58be1c0090559fd9172c6d54bda49ef87e48d',
      test: '0xd7e58be1c0090559fd9172c6d54bda49ef87e48d', // Mintable SHIB
    };
  }),
  ...
  ryoshiRewardAddress: "0x42a10bce8648ffdeb0f8dda7199c1043aae4b1d7", // MerkleDistributor
  ...
  rewardConfigs: computed('tokenAddress', 'allRewardConfigs', function() {
    console.log("Fernanado address 00: ", this.get('tokenAddress'))
